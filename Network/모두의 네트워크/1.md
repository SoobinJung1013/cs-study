...
- keywords
  ...
  - [Packet](#-lesson-2--정보의-양을-나타내는-단위)
  - [Bit와 Byte](#-lesson-3--lan과-wan)
  - [LAN / WAN](#-lesson-4--가정에서-하는-랜-구성)
  - [Server](#-lesson-5--회사에서-하는-랜-구성)
...
- 온프레미스 📍 사내 또는 데이터 센터에 서버를 두고 운영하는 것 \* 각 서버나 컴퓨터는 스위치나 무선랜 기능을 사용하여 사내랜에 접속
